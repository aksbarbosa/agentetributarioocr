...
APPLY_JSON = "outputs/apply-manual-review-pack-best.json"
APPLY_REPORT = "outputs/apply-manual-review-pack-best.report.md"
...
def get_pending_review_count(path: str) -> int:
    data = load_json(path)
...
def main() -> None:
    print("Continuando fluxo best OCR após revisão manual.")

    run_step(
        "Aplicar pacote de revisão manual best",
        [
            sys.executable,
    ...
    run_step(
        "Revisar novamente extrações best",
        [
            sys.executable,
    ...
    pack_code = run_step(
        "Gerar novo pacote de revisão manual best",
        [
            sys.executable,
    ...
    if pack_code != 0 or pending_count > 0:
        print("")
        print("Fluxo best interrompido: ainda há pendências de revisão.")
    ...
    run_step(
        "Aprovar extrações best corrigidas",
        [
            sys.executable,
    ...
    print("")
    print("Fluxo best pós-revisão manual finalizado com sucesso.")
